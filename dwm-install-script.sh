...
if [ "$DISTRO" = "arch" ]; then
    ...
    sudo pacman -S --needed --noconfirm zoxide git sxiv nwg-look lxappearance nitroogen neovim vim nsxiv fish fastfetch kitty stow starship trash-cli sxhkd nitrogen picom dunst polkit-gnome numlockx network-manager-applet parcellite feh
    ...
    log "Instalacja dodatkowych pakietów..."
    sudo apt install -y git zoxide neovim vim sxiv fish nwg-look lxappearance nitrogen fastfetch kitty nsxiv stow starship trash-cli sxhkd nitrogen picom dunst policykit-1-gnome numlockx network-manager-gnome parcellite feh neofetch
    check_success "Nie udało się zainstalować dodatkowych pakietów"
fi
