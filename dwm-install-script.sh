...
case "$DISTRO" in
    arch)
        ...
        YAY_PACKAGES=(brother-dcp1610w brscan4 google-chrome lm_sensors nwg-look mkinitcpio-firmware moc-pulse simple-sddm-theme-git sublime-text-4 ueberzug waypaper)
        ;;
    ubuntu)
...
stow Xresources/ alacritty/ background/ bash/ bin/ btop/ dunst/ fish/ fonts/ gtk-2.0/ gtk-3.0/ gtk-4.0/ gtkrc-2.0/ hypr/ icons/ kitty/ mako/ mc/ nvim/ nsxiv/ parcellite/ qt5ct/ ranger/ rofi/ suckless/ sublime-text/ themes/ thunar/ tldr/ sxiv/ swappy/ swaylock/ vim/ xfce4/ xinitrc/ xprofile/ yazi/ waybar/ wezterm/ wlogout/ wofi/ zathura/
