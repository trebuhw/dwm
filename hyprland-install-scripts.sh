...
case "$DISTRO" in
    arch)
        ...
        YAY_PACKAGES=(
        bibata-cursor-theme brother-dcp1610w brscan4 github-desktop google-chrome grimblast-git hyprland-qtutils-git hyprutils-git lpm moc-pulse mkinitcpio-firmware ookla-speedtest-bin simple-sddm-theme-git sublime-text-4 swaylock-effects-git swaylock-fancy-git waypaper wlogout)
        ;;
    ubuntu)
